...
q('2024', 9, 24, 'n4', '$\\overline{aabb}=(9c+2)^2$ raqamli tenglik', 'цифровое равенство $\\overline{aabb}=(9c+2)^2$')
q('2024', 9, 25, 'a1', 'ichma-ich ildizli tenglama', 'уравнение с вложенными радикалами')
q('2024', 9, 26, 'g1', 'bissektrisalar va $AP+OQ=AB$ sharti', 'биссектрисы и условие $AP+OQ=AB$')
