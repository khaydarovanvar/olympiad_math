...
window.LESSONS[12] = {
     ...
     "rows": {
      "ru": [
       [
        "общая",
        "$Ax+By+C=0$",
        "всегда; видна нормаль"
       ],
       [
        "с угловым коэффициентом",
        "$y=kx+b$",
        "прямая не вертикальна"
       ],
       [
        "через точку с наклоном",
        "$y-y_0=k\\left(x-x_0\\right)$",
        "известны точка и наклон"
       ],
       [
        "через две точки",
       ...
       [
        ...
        "известны точки пересечения с осями"
       ],
       [
        "параметрическая",
        "$\\left(x,y\\right)=\\left(x_0,y_0\\right)+t\\,\\vec{s}$",
        "нужна точка по параметру"
       ],
       [
        "нормальная",
      ...
      "en": [
       ...
       [
        "point–slope",
        "$y-y_0=k\\left(x-x_0\\right)$",
        "a point and the slope are known"
       ],
       [
        "two-point",
        "$\\dfrac{x-x_1}{x_2-x_1}=\\dfrac{y-y_1}{y_2-y_1}$",
       ...
       [
        "intercept",
        "$\\dfrac{x}{a}+\\dfrac{y}{b}=1$",
        "the axis intercepts are known"
       ],
       [
        "parametric",
        "$\\left(x,y\\right)=\\left(x_0,y_0\\right)+t\\,\\vec{s}$",
        "a point per parameter is needed"
       ],
       [
        "normal",
        "$x\\cos\\varphi+y\\sin\\varphi-p=0$",
   ...
   "blocks": [
    {
     "t": "p",
     "text": {
      "ru": "Координаты хороши тем, что переводят геометрию в алгебру. Векторы делают то же самое, но **без выбора системы координат**: формулировки становятся короче, а вычисления — устойчивее к неудачному расположению осей.",
      "en": "Coordinates are good because they turn geometry into algebra. Vectors do the same **without choosing axes at all**: statements get shorter and computations stop depending on a bad placement of the frame."
     }
    },
    {
     "t": "def",
     ...
     "text": {
      "ru": "Для векторов $\\vec{a}$ и $\\vec{b}$ полагают $$\\vec{a}\\cdot\\vec{b}=\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi ,$$ где $\\varphi$ — угол между ними. В координатах $\\vec{a}=\\left(a_1,a_2\\right)$, $\\vec{b}=\\left(b_1,b_2\\right)$ это $$\\vec{a}\\cdot\\vec{b}=a_1b_1+a_2b_2 .$$",
      "en": "For vectors $\\vec{a}$ and $\\vec{b}$ one sets $$\\vec{a}\\cdot\\vec{b}=\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi ,$$ where $\\varphi$ is the angle between them. In coordinates $\\vec{a}=\\left(a_1,a_2\\right)$, $\\vec{b}=\\left(b_1,b_2\\right)$ this is $$\\vec{a}\\cdot\\vec{b}=a_1b_1+a_2b_2 .$$"
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "**Согласованность двух определений.** Отложим оба вектора от начала координат; их концы — точки $A\\left(a_1,a_2\\right)$ и $B\\left(b_1,b_2\\right)$. По теореме косинусов в треугольнике $OAB$ $$AB^{2}=OA^{2}+OB^{2}-2\\cdot OA\\cdot OB\\cos\\varphi .$$\n\nВыразим все длины через координаты: $$\\left(a_1-b_1\\right)^{2}+\\left(a_2-b_2\\right)^{2}=\\left(a_1^{2}+a_2^{2}\\right)+\\left(b_1^{2}+b_2^{2}\\right)-2\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi .$$\n\nРаскроем левую часть: $$a_1^{2}-2a_1b_1+b_1^{2}+a_2^{2}-2a_2b_2+b_2^{2}.$$ Все квадраты сокращаются с правой частью, остаётся $$-2\\left(a_1b_1+a_2b_2\\right)=-2\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi ,$$ то есть $a_1b_1+a_2b_2=\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi$ ✓ $\\blacksquare$",
      "en": "**The two definitions agree.** Place both vectors at the origin; their tips are $A\\left(a_1,a_2\\right)$ and $B\\left(b_1,b_2\\right)$. The law of cosines in the triangle $OAB$ reads $$AB^{2}=OA^{2}+OB^{2}-2\\cdot OA\\cdot OB\\cos\\varphi .$$\n\nIn coordinates: $$\\left(a_1-b_1\\right)^{2}+\\left(a_2-b_2\\right)^{2}=\\left(a_1^{2}+a_2^{2}\\right)+\\left(b_1^{2}+b_2^{2}\\right)-2\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi .$$\n\nExpanding the left side, all the squares cancel against the right, leaving $$-2\\left(a_1b_1+a_2b_2\\right)=-2\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi ,$$ i.e. $a_1b_1+a_2b_2=\\left|\\vec{a}\\right|\\left|\\vec{b}\\right|\\cos\\varphi$ ✓ $\\blacksquare$"
     }
    },
    {
     "t": "thm",
     "name": {
      "ru": "Свойства скалярного произведения",
      "en": "Properties of the dot product"
     },
     "text": {
      "ru": "Для любых векторов и числа $\\lambda$\n\n- $\\vec{a}\\cdot\\vec{b}=\\vec{b}\\cdot\\vec{a}$;\n- $\\left(\\lambda\\vec{a}\\right)\\cdot\\vec{b}=\\lambda\\left(\\vec{a}\\cdot\\vec{b}\\right)$;\n- $\\vec{a}\\cdot\\left(\\vec{b}+\\vec{c}\\right)=\\vec{a}\\cdot\\vec{b}+\\vec{a}\\cdot\\vec{c}$;\n- $\\vec{a}\\cdot\\vec{a}=\\left|\\vec{a}\\right|^{2}\\ge0$, причём $=0$ только для нулевого вектора;\n- $\\vec{a}\\perp\\vec{b}\\iff\\vec{a}\\cdot\\vec{b}=0$.",
      "en": "For all vectors and every scalar $\\lambda$\n\n- $\\vec{a}\\cdot\\vec{b}=\\vec{b}\\cdot\\vec{a}$;\n- $\\left(\\lambda\\vec{a}\\right)\\cdot\\vec{b}=\\lambda\\left(\\vec{a}\\cdot\\vec{b}\\right)$;\n- $\\vec{a}\\cdot\\left(\\vec{b}+\\vec{c}\\right)=\\vec{a}\\cdot\\vec{b}+\\vec{a}\\cdot\\vec{c}$;\n- $\\vec{a}\\cdot\\vec{a}=\\left|\\vec{a}\\right|^{2}\\ge0$, and $=0$ only for the zero vector;\n- $\\vec{a}\\perp\\vec{b}\\iff\\vec{a}\\cdot\\vec{b}=0$."
     }
    },
    {
     "t": "idea",
     "text": {
      "ru": "Эти свойства означают, что **со скалярным произведением можно работать как с обычным умножением**: раскрывать скобки, возводить в квадрат, применять формулы сокращённого умножения. Отсюда основной приём: любое условие вида «отрезки равны» или «прямые перпендикулярны» записывается как равенство скалярных произведений и превращается в алгебру.\n\nОдин пример: $$\\left|\\vec{a}+\\vec{b}\\right|^{2}=\\left(\\vec{a}+\\vec{b}\\right)\\cdot\\left(\\vec{a}+\\vec{b}\\right)=\\left|\\vec{a}\\right|^{2}+2\\vec{a}\\cdot\\vec{b}+\\left|\\vec{b}\\right|^{2} .$$ Это и есть теорема косинусов, записанная в одну строку.",
      "en": "These properties say that **the dot product may be handled like ordinary multiplication**: expand brackets, square, use the standard identities. Hence the main technique: any hypothesis \"these segments are equal\" or \"these lines are perpendicular\" becomes an equation between dot products, i.e. algebra.\n\nOne example: $$\\left|\\vec{a}+\\vec{b}\\right|^{2}=\\left|\\vec{a}\\right|^{2}+2\\vec{a}\\cdot\\vec{b}+\\left|\\vec{b}\\right|^{2} ,$$ which is the law of cosines written in a single line."
     }
    },
    {
     "t": "ex",
     "q": {
      "ru": "Докажите векторами, что диагонали ромба перпендикулярны.",
      "en": "Prove with vectors that the diagonals of a rhombus are perpendicular."
     },
     "steps": {
      "ru": [
       "Пусть $\\vec{a}=\\overrightarrow{AB}$ и $\\vec{b}=\\overrightarrow{AD}$ — стороны ромба, выходящие из вершины $A$. Условие ромба: $\\left|\\vec{a}\\right|=\\left|\\vec{b}\\right|$.",
       "Диагонали равны $\\overrightarrow{AC}=\\vec{a}+\\vec{b}$ и $\\overrightarrow{DB}=\\vec{a}-\\vec{b}$.",
       "Найдём их скалярное произведение: $$\\left(\\vec{a}+\\vec{b}\\right)\\cdot\\left(\\vec{a}-\\vec{b}\\right)=\\left|\\vec{a}\\right|^{2}-\\left|\\vec{b}\\right|^{2}=0 .$$",
       "Скалярное произведение ненулевых векторов равно нулю, значит они перпендикулярны ✓",
       "Заодно доказано обратное: если диагонали параллелограмма перпендикулярны, то $\\left|\\vec{a}\\right|=\\left|\\vec{b}\\right|$ и он — ромб."
      ],
      "en": [
       "Let $\\vec{a}=\\overrightarrow{AB}$ and $\\vec{b}=\\overrightarrow{AD}$ be the sides at $A$. Being a rhombus means $\\left|\\vec{a}\\right|=\\left|\\vec{b}\\right|$.",
       "The diagonals are $\\overrightarrow{AC}=\\vec{a}+\\vec{b}$ and $\\overrightarrow{DB}=\\vec{a}-\\vec{b}$.",
       "Their dot product is $$\\left(\\vec{a}+\\vec{b}\\right)\\cdot\\left(\\vec{a}-\\vec{b}\\right)=\\left|\\vec{a}\\right|^{2}-\\left|\\vec{b}\\right|^{2}=0 .$$",
       "A zero dot product of non-zero vectors means they are perpendicular ✓",
       "The converse comes free: if the diagonals of a parallelogram are perpendicular then $\\left|\\vec{a}\\right|=\\left|\\vec{b}\\right|$ and it is a rhombus."
      ]
     },
     "ans": {
      "ru": "$\\left(\\vec{a}+\\vec{b}\\right)\\cdot\\left(\\vec{a}-\\vec{b}\\right)=\\left|\\vec{a}\\right|^{2}-\\left|\\vec{b}\\right|^{2}=0$.",
      "en": "$\\left(\\vec{a}+\\vec{b}\\right)\\cdot\\left(\\vec{a}-\\vec{b}\\right)=\\left|\\vec{a}\\right|^{2}-\\left|\\vec{b}\\right|^{2}=0$."
     }
    },
    {
     "t": "thm",
     "name": {
      "ru": "Центроид в векторах",
      "en": "The centroid in vectors"
     },
     "text": {
      "ru": "Для произвольной точки $O$ и треугольника $ABC$ точка $$G=\\frac13\\left(\\overrightarrow{OA}+\\overrightarrow{OB}+\\overrightarrow{OC}\\right)$$ является точкой пересечения медиан, и для неё $$\\overrightarrow{GA}+\\overrightarrow{GB}+\\overrightarrow{GC}=\\vec{0}.$$",
      "en": "For any origin $O$ and any triangle $ABC$, the point $$G=\\frac13\\left(\\overrightarrow{OA}+\\overrightarrow{OB}+\\overrightarrow{OC}\\right)$$ is the intersection of the medians, and it satisfies $$\\overrightarrow{GA}+\\overrightarrow{GB}+\\overrightarrow{GC}=\\vec{0}.$$"
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "Обозначим через $M$ середину $BC$, тогда $\\overrightarrow{OM}=\\tfrac12\\left(\\overrightarrow{OB}+\\overrightarrow{OC}\\right)$.\n\nВычислим точку, делящую медиану $AM$ в отношении $2:1$ от вершины: $$\\overrightarrow{OA}+\\frac23\\overrightarrow{AM}=\\overrightarrow{OA}+\\frac23\\left(\\overrightarrow{OM}-\\overrightarrow{OA}\\right)=\\frac13\\overrightarrow{OA}+\\frac23\\overrightarrow{OM}=\\frac13\\left(\\overrightarrow{OA}+\\overrightarrow{OB}+\\overrightarrow{OC}\\right).$$\n\nВыражение симметрично относительно $A$, $B$, $C$ — значит все три медианы содержат эту точку ✓ Это доказательство конкурентности медиан в две строки.\n\nВторое равенство получается, если взять $O=G$: тогда $\\overrightarrow{GA}+\\overrightarrow{GB}+\\overrightarrow{GC}=3\\,\\overrightarrow{GG}=\\vec{0}$ ✓ $\\blacksquare$",
      "en": "Let $M$ be the midpoint of $BC$, so $\\overrightarrow{OM}=\\tfrac12\\left(\\overrightarrow{OB}+\\overrightarrow{OC}\\right)$.\n\nCompute the point dividing the median $AM$ in the ratio $2:1$ from the vertex: $$\\overrightarrow{OA}+\\frac23\\left(\\overrightarrow{OM}-\\overrightarrow{OA}\\right)=\\frac13\\overrightarrow{OA}+\\frac23\\overrightarrow{OM}=\\frac13\\left(\\overrightarrow{OA}+\\overrightarrow{OB}+\\overrightarrow{OC}\\right).$$\n\nThe expression is symmetric in $A$, $B$, $C$, so all three medians contain this point ✓ That is a two-line proof of the concurrence of the medians.\n\nThe second identity follows by taking $O=G$: then $\\overrightarrow{GA}+\\overrightarrow{GB}+\\overrightarrow{GC}=3\\,\\overrightarrow{GG}=\\vec{0}$ ✓ $\\blacksquare$"
     }
    },
    {
     "t": "note",
     "text": {
      "ru": "В той же технике доказывается и красивая формула для ортоцентра: если $O$ — центр описанной окружности, то $$\\overrightarrow{OH}=\\overrightarrow{OA}+\\overrightarrow{OB}+\\overrightarrow{OC}.$$ Отсюда мгновенно следует прямая Эйлера: $\\overrightarrow{OH}=3\\,\\overrightarrow{OG}$, значит точки $O$, $G$, $H$ коллинеарны и $HG=2GO$.",
      "en": "The same technique gives the elegant formula for the orthocentre: if $O$ is the circumcentre then $$\\overrightarrow{OH}=\\overrightarrow{OA}+\\overrightarrow{OB}+\\overrightarrow{OC}.$$ The Euler line follows instantly: $\\overrightarrow{OH}=3\\,\\overrightarrow{OG}$, so $O$, $G$, $H$ are collinear and $HG=2GO$."
     }
    }
   ]
  },
   ...
   "blocks": [
    {
     "t": "p",
     "text": {
      "ru": "Координатный метод особенно силён там, где условие задачи — это **уравнение**: «найдите все точки, для которых…». Достаточно записать условие в координатах и упростить; полученное уравнение и есть ответ.",
      "en": "The coordinate method is at its strongest where the hypothesis is an **equation**: \"find all points such that…\". Write the condition in coordinates, simplify, and the resulting equation is the answer."
     }
    },
    {
     "t": "thm",
     "name": {
      "ru": "Окружность Аполлония",
      "en": "The circle of Apollonius"
     },
     "text": {
      "ru": "Пусть $A$ и $B$ — две различные точки и $k>0$, $k\\ne1$. Множество точек $M$, для которых $$\\frac{MA}{MB}=k ,$$ есть окружность, центр которой лежит на прямой $AB$. При $k=1$ это множество — серединный перпендикуляр к $AB$.",
      "en": "Let $A$ and $B$ be distinct points and $k>0$, $k\\ne1$. The set of points $M$ with $$\\frac{MA}{MB}=k$$ is a circle whose centre lies on the line $AB$. For $k=1$ the set is the perpendicular bisector of $AB$."
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "Выберем координаты так, чтобы $A=\\left(-a,0\\right)$ и $B=\\left(a,0\\right)$, где $2a=AB$. Условие $MA=k\\cdot MB$ после возведения в квадрат принимает вид $$\\left(x+a\\right)^{2}+y^{2}=k^{2}\\left[\\left(x-a\\right)^{2}+y^{2}\\right].$$\n\nРаскроем и соберём: $$\\left(1-k^{2}\\right)\\left(x^{2}+y^{2}\\right)+2ax\\left(1+k^{2}\\right)+a^{2}\\left(1-k^{2}\\right)=0 .$$\n\n**Если $k\\ne1$,** можно разделить на $1-k^{2}\\ne0$: $$x^{2}+y^{2}+2a\\,\\frac{1+k^{2}}{1-k^{2}}\\,x+a^{2}=0 .$$ Это уравнение вида $x^{2}+y^{2}+Dx+F=0$ — то есть окружность (после выделения полного квадрата), центр которой лежит на оси $Ox$, то есть на прямой $AB$ ✓\n\n**Если $k=1$,** члены с квадратами исчезают, и остаётся $4ax=0$, то есть $x=0$ — серединный перпендикуляр ✓ $\\blacksquare$\n\nПроверим, что окружность невырожденна: выделив полный квадрат, получаем радиус $$R=\\left|\\frac{2ak}{1-k^{2}}\\right|>0 \\quad\\checkmark$$",
      "en": "Choose coordinates with $A=\\left(-a,0\\right)$ and $B=\\left(a,0\\right)$, where $2a=AB$. Squaring $MA=k\\cdot MB$ gives $$\\left(x+a\\right)^{2}+y^{2}=k^{2}\\left[\\left(x-a\\right)^{2}+y^{2}\\right].$$\n\nExpanding and collecting, $$\\left(1-k^{2}\\right)\\left(x^{2}+y^{2}\\right)+2ax\\left(1+k^{2}\\right)+a^{2}\\left(1-k^{2}\\right)=0 .$$\n\n**If $k\\ne1$** divide by $1-k^{2}\\ne0$: $$x^{2}+y^{2}+2a\\,\\frac{1+k^{2}}{1-k^{2}}\\,x+a^{2}=0 ,$$ an equation of the form $x^{2}+y^{2}+Dx+F=0$ — a circle (complete the square) whose centre lies on the axis $Ox$, i.e. on the line $AB$ ✓\n\n**If $k=1$** the quadratic terms vanish and $4ax=0$ remains, i.e. $x=0$ — the perpendicular bisector ✓ $\\blacksquare$\n\nThe circle is non-degenerate: completing the square gives the radius $$R=\\left|\\frac{2ak}{1-k^{2}}\\right|>0 \\quad\\checkmark$$"
     }
    },
    {
     "t": "note",
     "text": {
      "ru": "Окружность Аполлония объясняет свойство биссектрис: внутренняя и внешняя биссектрисы угла $A$ треугольника пересекают прямую $BC$ в двух точках, делящих её в одном и том же отношении $\\dfrac{AB}{AC}$ — но одна внутренним, другая внешним образом. Эти две точки и есть концы диаметра соответствующей окружности Аполлония.",
      "en": "The circle of Apollonius explains the bisector picture: the internal and external bisectors of the angle $A$ meet the line $BC$ at two points dividing it in the same ratio $\\dfrac{AB}{AC}$ — one internally, one externally. Those two points are the ends of a diameter of the corresponding Apollonius circle."
     }
    },
    {
     "t": "thm",
     "name": {
      "ru": "Уравнение касательной к окружности",
      "en": "The tangent line to a circle"
     },
     "text": {
      "ru": "Касательная к окружности $\\left(x-x_0\\right)^{2}+\\left(y-y_0\\right)^{2}=R^{2}$ в её точке $M_1=\\left(x_1,y_1\\right)$ задаётся уравнением $$\\left(x_1-x_0\\right)\\left(x-x_0\\right)+\\left(y_1-y_0\\right)\\left(y-y_0\\right)=R^{2}.$$",
      "en": "The tangent to the circle $\\left(x-x_0\\right)^{2}+\\left(y-y_0\\right)^{2}=R^{2}$ at a point $M_1=\\left(x_1,y_1\\right)$ of it is $$\\left(x_1-x_0\\right)\\left(x-x_0\\right)+\\left(y_1-y_0\\right)\\left(y-y_0\\right)=R^{2}.$$"
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "Касательная перпендикулярна радиусу $\\overrightarrow{OM_1}=\\left(x_1-x_0,\\,y_1-y_0\\right)$, значит этот вектор — её нормаль. Уравнение прямой через $M_1$ с такой нормалью: $$\\left(x_1-x_0\\right)\\left(x-x_1\\right)+\\left(y_1-y_0\\right)\\left(y-y_1\\right)=0 .$$\n\nПрибавим к обеим частям $\\left(x_1-x_0\\right)^{2}+\\left(y_1-y_0\\right)^{2}=R^{2}$ и сгруппируем: слева получится $$\\left(x_1-x_0\\right)\\left(x-x_1+x_1-x_0\\right)+\\left(y_1-y_0\\right)\\left(y-y_1+y_1-y_0\\right),$$ то есть в точности левая часть требуемого равенства ✓ $\\blacksquare$",
      "en": "The tangent is perpendicular to the radius $\\overrightarrow{OM_1}=\\left(x_1-x_0,\\,y_1-y_0\\right)$, so that vector is its normal. The line through $M_1$ with this normal is $$\\left(x_1-x_0\\right)\\left(x-x_1\\right)+\\left(y_1-y_0\\right)\\left(y-y_1\\right)=0 .$$\n\nAdd $\\left(x_1-x_0\\right)^{2}+\\left(y_1-y_0\\right)^{2}=R^{2}$ to both sides and regroup: the left side becomes $$\\left(x_1-x_0\\right)\\left(x-x_0\\right)+\\left(y_1-y_0\\right)\\left(y-y_0\\right) ,$$ exactly as claimed ✓ $\\blacksquare$"
     }
    },
    {
     "t": "ex",
     "q": {
      "ru": "Найдите множество точек $M$, для которых $MA=2\\,MB$, если $A\\left(-3,0\\right)$ и $B\\left(3,0\\right)$.",
      "en": "Find the set of points $M$ with $MA=2\\,MB$, where $A\\left(-3,0\\right)$ and $B\\left(3,0\\right)$."
     },
     "steps": {
      "ru": [
       "Запишем условие в координатах и возведём в квадрат: $$\\left(x+3\\right)^{2}+y^{2}=4\\left[\\left(x-3\\right)^{2}+y^{2}\\right].$$",
       "Раскроем: $x^{2}+6x+9+y^{2}=4x^{2}-24x+36+4y^{2}$.",
       "Перенесём всё вправо: $3x^{2}+3y^{2}-30x+27=0$, то есть $x^{2}+y^{2}-10x+9=0$.",
       "Выделим полный квадрат: $\\left(x-5\\right)^{2}+y^{2}=16$.",
       "Это окружность с центром $\\left(5,0\\right)$ и радиусом $4$. Проверим точку $\\left(1,0\\right)$: $MA=4$, $MB=2$ ✓ И точку $\\left(9,0\\right)$: $MA=12$, $MB=6$ ✓"
      ],
      "en": [
       "Write the condition in coordinates and square: $$\\left(x+3\\right)^{2}+y^{2}=4\\left[\\left(x-3\\right)^{2}+y^{2}\\right].$$",
       "Expand: $x^{2}+6x+9+y^{2}=4x^{2}-24x+36+4y^{2}$.",
       "Collect: $3x^{2}+3y^{2}-30x+27=0$, i.e. $x^{2}+y^{2}-10x+9=0$.",
       "Complete the square: $\\left(x-5\\right)^{2}+y^{2}=16$.",
       "A circle of centre $\\left(5,0\\right)$ and radius $4$. Check $\\left(1,0\\right)$: $MA=4$, $MB=2$ ✓ And $\\left(9,0\\right)$: $MA=12$, $MB=6$ ✓"
      ]
     },
     "ans": {
      "ru": "Окружность $\\left(x-5\\right)^{2}+y^{2}=16$.",
      "en": "The circle $\\left(x-5\\right)^{2}+y^{2}=16$."
     }
    },
    {
     "t": "idea",
     "text": {
      "ru": "**Как выбрать систему координат.** Правильный выбор осей сокращает вычисления в разы:\n\n- начало координат — в вершине прямого угла или в центре симметрии;\n- ось $Ox$ — вдоль самой длинной стороны или вдоль оси симметрии;\n- используйте симметрию условия: если в задаче есть отрезок, ставьте его концы в $\\left(-a,0\\right)$ и $\\left(a,0\\right)$, а не в $\\left(0,0\\right)$ и $\\left(2a,0\\right)$;\n- если фигура задана с точностью до подобия, можно положить одну из длин равной $1$.",
      "en": "**How to choose the frame.** A good choice of axes cuts the work several times over:\n\n- put the origin at a right-angle vertex or at a centre of symmetry;\n- align $Ox$ with the longest side or with an axis of symmetry;\n- exploit the symmetry of the hypothesis: given a segment, place its ends at $\\left(-a,0\\right)$ and $\\left(a,0\\right)$, not at $\\left(0,0\\right)$ and $\\left(2a,0\\right)$;\n- if the figure is only determined up to similarity, one length may be set equal to $1$."
     }
    }
   ]
  }
 ...
 "problems": [
  ...
  },
  {
   "src": {
    "ru": "Окружность Аполлония",
    "en": "The Apollonius circle",
    "uz": "Apolloniy aylanasi"
   },
   "lvl": 3,
   "q": {
