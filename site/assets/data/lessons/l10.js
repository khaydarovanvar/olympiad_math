   ...
   "blocks": [
    {
     "t": "p",
     "text": {
      "ru": "Формулы площади не нужно заучивать списком: все они выводятся из одной — площади прямоугольника — за несколько шагов. Разберём цепочку целиком, а заодно получим формулы, которых нет в школьном учебнике.",
      "en": "The area formulas do not have to be memorised as a list: they all follow from one — the area of a rectangle — in a few steps. Here is the whole chain, together with some formulas the school textbook omits."
     }
    },
    {
     "t": "thm",
     "name": {
      "ru": "Площадь параллелограмма и треугольника",
      "en": "The area of a parallelogram and of a triangle"
     },
     "text": {
      "ru": "$$S_{\\text{пар}}=a h_a ,\\qquad S_{\\triangle}=\\frac12 a h_a .$$",
      "en": "$$S_{\\text{par}}=a h_a ,\\qquad S_{\\triangle}=\\frac12 a h_a .$$"
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "**Параллелограмм.** Отрежем от параллелограмма $ABCD$ прямоугольный треугольник, отсекаемый высотой из вершины $A$, и приставим его к противоположной стороне. Получится прямоугольник с основанием $a$ и высотой $h_a$, площадь которого равна $ah_a$. Разрезание и перекладывание площадь не меняют ✓\n\n**Треугольник.** Достроим треугольник $ABC$ до параллелограмма, приложив к стороне $BC$ его копию, повёрнутую на $180^{\\circ}$ вокруг середины $BC$. Параллелограмм состоит из двух равных треугольников, значит площадь каждого равна половине ✓ $\\blacksquare$",
      "en": "**Parallelogram.** Cut off the right triangle that the altitude from $A$ separates from $ABCD$ and reattach it at the opposite side. The result is a rectangle of base $a$ and height $h_a$, whose area is $ah_a$. Cutting and rearranging does not change area ✓\n\n**Triangle.** Complete $ABC$ to a parallelogram by attaching to the side $BC$ its own copy rotated by $180^{\\circ}$ about the midpoint of $BC$. The parallelogram consists of two congruent triangles, so each has half the area ✓ $\\blacksquare$"
     }
    },
    {
     "t": "thm",
     "name": {
      "ru": "Площадь через две стороны и угол",
      "en": "Area from two sides and the included angle"
     },
     "text": {
      "ru": "$$S=\\frac12\\,ab\\sin C .$$",
      "en": "$$S=\\frac12\\,ab\\sin C .$$"
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "Высота из вершины $A$ на прямую $BC$ равна $h_a=b\\sin C$ — это определение синуса в прямоугольном треугольнике, отсекаемом высотой (при тупом $C$ синус смежного угла тот же, поэтому формула сохраняется).\n\nПодставим в $S=\\tfrac12 a h_a$ ✓ $\\blacksquare$\n\n**Следствие.** При фиксированных сторонах $a$ и $b$ площадь максимальна, когда $\\sin C=1$, то есть при $C=90^{\\circ}$. Это готовый ответ для целого класса задач на максимум.",
      "en": "The altitude from $A$ to the line $BC$ equals $h_a=b\\sin C$ — the definition of the sine in the right triangle cut off by the altitude (for obtuse $C$ the supplementary angle has the same sine, so the formula survives).\n\nSubstitute into $S=\\tfrac12 a h_a$ ✓ $\\blacksquare$\n\n**Corollary.** With $a$ and $b$ fixed the area is largest when $\\sin C=1$, i.e. $C=90^{\\circ}$. That answers a whole family of maximisation problems at once."
     }
    },
    {
     "t": "thm",
     ...
     "text": {
      "ru": "Если $p=\\dfrac{a+b+c}{2}$ — полупериметр, то $$S=\\sqrt{p\\left(p-a\\right)\\left(p-b\\right)\\left(p-c\\right)} .$$",
      "en": "If $p=\\dfrac{a+b+c}{2}$ is the semiperimeter then $$S=\\sqrt{p\\left(p-a\\right)\\left(p-b\\right)\\left(p-c\\right)} .$$"
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "Начнём с $S=\\tfrac12 ab\\sin C$ и выразим синус через косинус: $$16S^{2}=4a^{2}b^{2}\\sin^{2}C=4a^{2}b^{2}\\left(1-\\cos^{2}C\\right)=\\left(2ab\\right)^{2}-\\left(2ab\\cos C\\right)^{2}.$$\n\nПо теореме косинусов $2ab\\cos C=a^{2}+b^{2}-c^{2}$, поэтому $$16S^{2}=\\left(2ab\\right)^{2}-\\left(a^{2}+b^{2}-c^{2}\\right)^{2}.$$\n\nЭто разность квадратов: $$16S^{2}=\\left(2ab+a^{2}+b^{2}-c^{2}\\right)\\left(2ab-a^{2}-b^{2}+c^{2}\\right)=\\left[\\left(a+b\\right)^{2}-c^{2}\\right]\\left[c^{2}-\\left(a-b\\right)^{2}\\right].$$\n\nКаждая скобка — снова разность квадратов: $$16S^{2}=\\left(a+b+c\\right)\\left(a+b-c\\right)\\left(c+a-b\\right)\\left(c-a+b\\right).$$\n\nОстаётся заметить, что эти четыре множителя равны $2p$, $2\\left(p-c\\right)$, $2\\left(p-b\\right)$, $2\\left(p-a\\right)$, а их произведение — $16\\,p\\left(p-a\\right)\\left(p-b\\right)\\left(p-c\\right)$ ✓ $\\blacksquare$",
      "en": "Start from $S=\\tfrac12 ab\\sin C$ and turn the sine into a cosine: $$16S^{2}=4a^{2}b^{2}\\left(1-\\cos^{2}C\\right)=\\left(2ab\\right)^{2}-\\left(2ab\\cos C\\right)^{2}.$$\n\nThe law of cosines gives $2ab\\cos C=a^{2}+b^{2}-c^{2}$, so $$16S^{2}=\\left(2ab\\right)^{2}-\\left(a^{2}+b^{2}-c^{2}\\right)^{2}.$$\n\nThat is a difference of squares: $$16S^{2}=\\left[\\left(a+b\\right)^{2}-c^{2}\\right]\\left[c^{2}-\\left(a-b\\right)^{2}\\right].$$\n\nEach bracket is again a difference of squares: $$16S^{2}=\\left(a+b+c\\right)\\left(a+b-c\\right)\\left(c+a-b\\right)\\left(c-a+b\\right).$$\n\nThe four factors are $2p$, $2\\left(p-c\\right)$, $2\\left(p-b\\right)$, $2\\left(p-a\\right)$, whose product is $16\\,p\\left(p-a\\right)\\left(p-b\\right)\\left(p-c\\right)$ ✓ $\\blacksquare$"
     }
    },
    {
     "t": "thm",
     "name": {
      "ru": "Площадь через радиусы окружностей",
      "en": "Area from the two radii"
     },
     "text": {
      "ru": "$$S=p\\,r\\qquad\\text{и}\\qquad S=\\frac{abc}{4R},$$ где $r$ — радиус вписанной, $R$ — радиус описанной окружности.",
      "en": "$$S=p\\,r\\qquad\\text{and}\\qquad S=\\frac{abc}{4R},$$ where $r$ is the inradius and $R$ the circumradius."
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "**Первая формула.** Соединим центр вписанной окружности $I$ с вершинами. Треугольник разбивается на три: $IBC$, $ICA$, $IAB$. Высота каждого из них, опущенная на соответствующую сторону, равна $r$ (радиус, проведённый в точку касания, перпендикулярен стороне). Значит $$S=\\frac12 ar+\\frac12 br+\\frac12 cr=\\frac{a+b+c}{2}\\,r=pr \\quad\\checkmark$$\n\n**Вторая формула.** По теореме синусов $\\dfrac{c}{\\sin C}=2R$, то есть $\\sin C=\\dfrac{c}{2R}$. Подставим в $S=\\tfrac12 ab\\sin C$: $$S=\\frac12 ab\\cdot\\frac{c}{2R}=\\frac{abc}{4R} \\quad\\checkmark\\qquad\\blacksquare$$",
      "en": "**The first.** Join the incentre $I$ to the vertices, splitting the triangle into $IBC$, $ICA$, $IAB$. The altitude of each to the corresponding side is $r$ (the radius to a point of tangency is perpendicular to the side). Hence $$S=\\frac12 ar+\\frac12 br+\\frac12 cr=pr \\quad\\checkmark$$\n\n**The second.** The law of sines gives $\\dfrac{c}{\\sin C}=2R$, so $\\sin C=\\dfrac{c}{2R}$. Substituting into $S=\\tfrac12 ab\\sin C$, $$S=\\frac{abc}{4R} \\quad\\checkmark\\qquad\\blacksquare$$"
     }
    },
    {
     "t": "note",
     "text": {
      "ru": "Формула $S=pr$ — рабочая лошадка задач про вписанную окружность: она мгновенно даёт $r=\\dfrac{S}{p}$. Вместе с формулой Герона это позволяет найти $r$ и $R$ по трём сторонам, ничего не строя.",
      "en": "The formula $S=pr$ is the workhorse of incircle problems: it gives $r=\\dfrac{S}{p}$ at once. Together with Heron it yields $r$ and $R$ from the three sides with no construction at all."
     }
    },
    {
     "t": "ex",
     "q": {
      "ru": "В треугольнике со сторонами $13$, $14$, $15$ найдите площадь, радиус вписанной и радиус описанной окружностей.",
      "en": "For the triangle with sides $13$, $14$, $15$ find the area, the inradius and the circumradius."
     },
     "steps": {
      "ru": [
       "Полупериметр: $p=\\dfrac{13+14+15}{2}=21$.",
       "Герон: $S=\\sqrt{21\\cdot8\\cdot7\\cdot6}=\\sqrt{7056}=84$.",
       "Вписанная: $r=\\dfrac{S}{p}=\\dfrac{84}{21}=4$.",
       "Описанная: $R=\\dfrac{abc}{4S}=\\dfrac{13\\cdot14\\cdot15}{4\\cdot84}=\\dfrac{2730}{336}=\\dfrac{65}{8}=8{,}125$.",
       "Проверка неравенством Эйлера $R\\ge2r$: $8{,}125\\ge8$ ✓"
      ],
      "en": [
       "Semiperimeter: $p=\\dfrac{13+14+15}{2}=21$.",
       "Heron: $S=\\sqrt{21\\cdot8\\cdot7\\cdot6}=\\sqrt{7056}=84$.",
       "Inradius: $r=\\dfrac{S}{p}=\\dfrac{84}{21}=4$.",
       "Circumradius: $R=\\dfrac{abc}{4S}=\\dfrac{2730}{336}=\\dfrac{65}{8}=8.125$.",
       "Check with the inequality of Euler $R\\ge2r$: $8.125\\ge8$ ✓"
      ]
     },
     "ans": {
      "ru": "$S=84$, $r=4$, $R=\\dfrac{65}{8}$.",
      "en": "$S=84$, $r=4$, $R=\\dfrac{65}{8}$."
     }
    },
    {
     "t": "table",
     ...
     "rows": {
      "ru": [
       ...
       [
        "треугольник",
        "$pr$",
        "речь о вписанной окружности"
       ],
       [
        "треугольник",
        "$\\tfrac{abc}{4R}$",
        "речь об описанной окружности"
       ],
       [
        "трапеция",
        "$\\tfrac{a+b}{2}\\,h$",
       ...
       [
        "ромб / любой четырёхугольник с $d_1\\perp d_2$",
        "$\\tfrac12 d_1d_2$",
        "диагонали перпендикулярны"
       ],
       [
        "произвольный четырёхугольник",
        "$\\tfrac12 d_1d_2\\sin\\varphi$",
        "известен угол между диагоналями"
       ]
      ],
      "en": [
       [
        "triangle",
        "$\\tfrac12 a h_a$",
        "an altitude is known"
       ],
       [
        "triangle",
        "$\\tfrac12 ab\\sin C$",
        "two sides and the angle are known"
       ],
       [
        "triangle",
        "$\\sqrt{p(p-a)(p-b)(p-c)}$",
       ...
       [
        "triangle",
        "$pr$",
        "the incircle is involved"
       ],
       [
        "triangle",
        "$\\tfrac{abc}{4R}$",
        "the circumcircle is involved"
       ],
       [
        "trapezium",
        "$\\tfrac{a+b}{2}\\,h$",
       ...
       [
        "rhombus / any quadrilateral with $d_1\\perp d_2$",
        "$\\tfrac12 d_1d_2$",
       ...
       [
        ...
        "$\\tfrac12 d_1d_2\\sin\\varphi$",
        "the angle between the diagonals is known"
       ]
      ]
     }
    }
  ...
  },
  {
   ...
   "blocks": [
    ...
    },
    {
     "t": "thm",
     "name": {
      "ru": "Лемма об отношении на чевиане",
      "en": "The ratio lemma on a cevian"
     },
     "text": {
      "ru": "Пусть чевиана $AX$ проведена к стороне $BC$, а точка $P$ лежит на ней. Тогда $$\\frac{AP}{PX}=\\frac{S_{ABP}+S_{ACP}}{S_{BPC}}\\qquad\\text{и}\\qquad \\frac{BX}{XC}=\\frac{S_{ABP}}{S_{ACP}} .$$",
      "en": "Let $AX$ be a cevian to the side $BC$ and let $P$ lie on it. Then $$\\frac{AP}{PX}=\\frac{S_{ABP}+S_{ACP}}{S_{BPC}}\\qquad\\text{and}\\qquad \\frac{BX}{XC}=\\frac{S_{ABP}}{S_{ACP}} .$$"
     }
    },
    {
     "t": "proof",
     "text": {
      "ru": "Треугольники $ABP$ и $XBP$ имеют общее основание $BP$, а вершины $A$ и $X$ лежат на одной прямой, поэтому отношение их площадей равно отношению расстояний от $A$ и $X$ до прямой $BP$, то есть $\\dfrac{AP}{PX}$. То же верно для пары $ACP$ и $XCP$.\n\nСложим числители и знаменатели двух равных дробей — отношение не изменится: $$\\frac{AP}{PX}=\\frac{S_{ABP}}{S_{XBP}}=\\frac{S_{ACP}}{S_{XCP}}=\\frac{S_{ABP}+S_{ACP}}{S_{XBP}+S_{XCP}}=\\frac{S_{ABP}+S_{ACP}}{S_{BPC}} \\quad\\checkmark$$\n\nВторое равенство: треугольники $ABX$ и $AXC$ (общая высота из $A$) дают $\\dfrac{BX}{XC}=\\dfrac{S_{ABX}}{S_{AXC}}$, а треугольники $PBX$ и $PXC$ (общая высота из $P$) дают то же отношение. Вычитая площади, получаем $$\\frac{BX}{XC}=\\frac{S_{ABX}-S_{PBX}}{S_{AXC}-S_{PXC}}=\\frac{S_{ABP}}{S_{ACP}} \\quad\\checkmark\\qquad\\blacksquare$$",
      "en": "The triangles $ABP$ and $XBP$ share the base $BP$, and $A$, $X$ lie on one line, so the ratio of their areas equals the ratio of the distances from $A$ and $X$ to the line $BP$, namely $\\dfrac{AP}{PX}$. The same holds for the pair $ACP$, $XCP$.\n\nAdding numerators and denominators of two equal fractions does not change their value: $$\\frac{AP}{PX}=\\frac{S_{ABP}}{S_{XBP}}=\\frac{S_{ACP}}{S_{XCP}}=\\frac{S_{ABP}+S_{ACP}}{S_{BPC}} \\quad\\checkmark$$\n\nFor the second: $ABX$ and $AXC$ (common altitude from $A$) give $\\dfrac{BX}{XC}=\\dfrac{S_{ABX}}{S_{AXC}}$, and $PBX$, $PXC$ (common altitude from $P$) give the same ratio. Subtracting areas, $$\\frac{BX}{XC}=\\frac{S_{ABX}-S_{PBX}}{S_{AXC}-S_{PXC}}=\\frac{S_{ABP}}{S_{ACP}} \\quad\\checkmark\\qquad\\blacksquare$$"
     }
    },
    {
     "t": "idea",
     "text": {
      "ru": "Эта лемма превращает **любое** отношение отрезков в отношение площадей и обратно. Стандартная схема решения «методом площадей»: обозначьте площади трёх маленьких треугольников через $x$, $y$, $z$, выпишите данные условия как уравнения на них, решите систему — и переведите ответ обратно в отношение отрезков.",
      "en": "This lemma converts **any** ratio of segments into a ratio of areas and back. The standard scheme of the area method: call the areas of the three small triangles $x$, $y$, $z$, write the hypotheses as equations in them, solve, then translate the answer back into a ratio of segments."
     }
    },
    {
     "t": "ex",
     "q": {
      "ru": "Медианы треугольника пересекаются в точке $G$. Докажите методом площадей, что $AG:GM=2:1$, где $M$ — середина $BC$.",
      "en": "The medians of a triangle meet at $G$. Use the area method to prove that $AG:GM=2:1$, where $M$ is the midpoint of $BC$."
     },
     "steps": {
      "ru": [
       "Обозначим $S_{BGC}=x$, $S_{CGA}=y$, $S_{AGB}=z$.",
       "Медиана $AM$ делит $BC$ пополам, значит по лемме $\\dfrac{BM}{MC}=\\dfrac{S_{ABG}}{S_{ACG}}=\\dfrac{z}{y}=1$, то есть $y=z$.",
       "Медиана из $B$ даёт точно так же $x=y$. Значит $x=y=z$ — три площади равны.",
       "По первой части леммы $$\\frac{AG}{GM}=\\frac{S_{ABG}+S_{ACG}}{S_{BGC}}=\\frac{z+y}{x}=\\frac{2x}{x}=2 \\quad\\checkmark$$",
       "Попутно доказано, что медианы делят треугольник на три равновеликие части (а с учётом половинок — на шесть)."
      ],
      "en": [
       "Write $S_{BGC}=x$, $S_{CGA}=y$, $S_{AGB}=z$.",
       "The median $AM$ bisects $BC$, so the lemma gives $\\dfrac{BM}{MC}=\\dfrac{z}{y}=1$, i.e. $y=z$.",
       "The median from $B$ gives $x=y$ in the same way. So $x=y=z$ — the three areas are equal.",
       "The first part of the lemma now gives $$\\frac{AG}{GM}=\\frac{z+y}{x}=\\frac{2x}{x}=2 \\quad\\checkmark$$",
       "On the way we proved that the medians cut the triangle into three pieces of equal area (and, halving each, into six)."
      ]
     },
     "ans": {
      "ru": "$AG:GM=2:1$.",
   ...
   "blocks": [
    {
     "t": "p",
     "text": {
      "ru": "Теорема Чевы отвечает на вопрос «когда три чевианы пересекаются в одной точке». Её близнец — теорема Менелая — отвечает на вопрос «когда три точки лежат на одной прямой». Вместе они закрывают большинство задач про отношения отрезков.",
      "en": "The theorem of Ceva answers \"when do three cevians meet at one point\". Its twin, the theorem of Menelaus, answers \"when do three points lie on one line\". Together they cover most problems about ratios of segments."
     }
    },
    {
     "t": "thm",
