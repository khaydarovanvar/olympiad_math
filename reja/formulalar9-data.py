...
I(nom=T('EKUB va EKUK bogʻlanishi', 'Связь НОД и НОК'),
  tex=(r'\mathrm{EKUB}(a,b)\cdot\mathrm{EKUK}(a,b)=a\cdot b',
      r'\mathrm{НОД}(a,b)\cdot\mathrm{НОК}(a,b)=a\cdot b'),
